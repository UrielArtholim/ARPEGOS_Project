...
namespace ARPEGOS.Services
{
    ...
    public abstract partial class OntologyService
    {
        ...
        /// <returns></returns>
        public bool CheckCostAndLimit(string cost, string limit)
        {
        ...
        /// <returns></returns>
        public RDFModelEnums.RDFDatatypes CheckDatatypeFromString(string type)
        {
            switch (type)
            {
                case "XMLLiteral":
        ...
        /// <returns></returns>
        public RDFOntologyClass CheckClassFromDatatype(RDFModelEnums.RDFDatatypes datatype)
        {
            switch (datatype)
            {
