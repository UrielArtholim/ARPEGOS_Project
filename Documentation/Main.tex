...
\newcommand{\dia}{8 \textvisiblespace}
\newcommand{\mes}{Septiembre \textvisiblespace}
\newcommand{\anno}{2020}
...
\begin{document}
    ...
    % Import Preface
    \input{Documentation-Scheme/Portada/Preface.tex}
    \blankpage{}
    ...
    % Import Part I
    \input{Documentation-Scheme/Prolegómeno.tex}
    \blankpage{}

    % Import Part II
    \input{Documentation-Scheme/Desarrollo.tex}
    \blankpage{}

    % Import Part III
    \input{Documentation-Scheme/Epílogo.tex}
    \blankpage{}
