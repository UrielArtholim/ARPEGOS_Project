...
\begin{document}
    ...
    \pagestyle{fancy}
    % Import Signature
    \input{Documentation_Scheme/Portada/Signature.tex}
    \blankpage{}
    
    % Import Preface
    \input{Documentation_Scheme/Portada/Preface.tex}
    \blankpage{}
    ...
    % Import Part I
    \input{Documentation_Scheme/Prolegómeno.tex}
    \blankpage{}

    % Import Part II
    \input{Documentation_Scheme/Desarrollo.tex}
    \blankpage{}

    % Import Part III
    \input{Documentation_Scheme/Epílogo.tex}
    \blankpage{}
