...
%\begin{figure}
%    \centering
%    \includegraphics[width=5cm]{Figures/Diagrama_Gantt_0}
%    \caption{Diagrama de Gantt: Sprint 0}
%\end{figure}

%\begin{figure}
%    \centering
%    \includegraphics[width=5cm]{Figures/Diagrama_Gantt_1}
%    \caption{Diagrama de Gantt: Sprint 1}
%\end{figure}

%\begin{figure}
%    \centering
%    \includegraphics[width=5cm]{Figures/Diagrama_Gantt_2}
%    \caption{Diagrama de Gantt: Sprint 2}
%\end{figure}

%\begin{figure}
%    \centering
%    \includegraphics[width=5cm]{Figures/Diagrama_Gantt_3}
%    \caption{Diagrama de Gantt: Sprint 3}
%\end{figure}

%\begin{figure}
%    \centering
%    \includegraphics[width=5cm]{Figures/Diagrama_Gantt_4}
%    \caption{Diagrama de Gantt: Sprint 4}
%\end{figure}

%\begin{figure}
%    \centering
%    \includegraphics[width=5cm]{Figures/Diagrama_Gantt_5}
%    \caption{Diagrama de Gantt: Sprint 5}
%\end{figure}

%\begin{figure}
%    \centering
%    \includegraphics[width=5cm]{Figures/Diagrama_Gantt_6}
%    \caption{Diagrama de Gantt: Sprint 6}
%\end{figure}
