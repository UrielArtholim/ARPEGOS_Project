...
% Signature Page %
\begin{declaracion}
    \Large \MakeUppercase{\textbf{\underline{Declaración Personal de Autoría}}}
    
    \justify{\normalsize{} \autor{} con DNI \DNI{}, estudiante del \titulacion{} en la Escuela Superior de Ingeniería de la Universidad de Cádiz,
    como autor de este documento academico, titulado \textit{\proyecto{}} y presentado como trabajo final 
    de \tipo{}} 
    ...
    \justify{\normalsize{} En Puerto Real, a \Fecha{} }\\ \vspace{1cm}
