...
Para poder definir las etapas de creación de \textit{Ánima}, se han planteado las siguientes preguntas:
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.5]{Documentation-Scheme/Desarrollo/Análisis-Sistema/Etapas_Anima.pdf}
