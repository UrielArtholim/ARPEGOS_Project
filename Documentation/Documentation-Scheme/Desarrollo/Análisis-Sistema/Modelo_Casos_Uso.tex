...
%1: Listar juegos <- Seleccionar juego
%2: Listar opciones Etapa <- Seleccionar opcion/es Etapa || <- Mostrar información personaje
%3: Mostrar pantalla principal visualización -> Cambiar pestaña visualización 
%4: Mostrar pantalla principal visualización -> Cambiar pestaña visualización <- Pulsar botón modificar <- Listar opciones Etapa <- Seleccionar opcion/es Etapa <- Mostrar última pantalla visualización
%5: Listar personaje <- Seleccionar personaje
%6: Introducir valor <- Leer valor
